...
def test_parquet_shards_mirror_source_order_and_schema(tmp_path: Path):
    ...
    t0 = pq.read_table(out / "shard-00000.parquet")  # shards at root, mirror source
